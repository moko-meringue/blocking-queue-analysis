...
|:-----------------------|:-------------|:---------------------|:---------------------|
| **ArrayBlockingQueue** | **875.4 ms** | **약 22,846,755 건/초** | **✅ 최적 (약 1.5배 빠름)** |
| LinkedBlockingQueue    | 1,315.4 ms   | 약 15,204,500 건/초     |                      |
...
| 큐 종류                    | 평균 소요 시간       | 처리율 (Throughput)     | 결과                   |
|:------------------------|:---------------|:---------------------|:---------------------|
| ArrayBlockingQueue      | 1,287.2 ms     | 약 15,537,508 건/초     |                      |
| **LinkedBlockingQueue** | **1,020.0 ms** | **약 19,603,999 건/초** | **✅ 최적 (약 1.3배 빠름)** |
...
- Time: 897, 834, 846, 918, 882 (ms)
- Avg: 875.4 ms

**2. Single Consumer - LinkedBlockingQueue**

- Time: 1266, 1362, 1373, 1419, 1157 (ms)
- Avg: 1315.4 ms

**3. Multi Consumer - ArrayBlockingQueue**

- Time: 1270, 1307, 1318, 1268, 1273 (ms)
- Avg: 1287.2 ms

**4. Multi Consumer - LinkedBlockingQueue**

- Time: 1073, 1081, 967, 951, 1029 (ms)
- Avg: 1020.0 ms
...
소비자가 적거나, 스레드 경합이 심하지 않을 때.

### `LinkedBlockingQueue`가 적절한 경우

큐의 크기가 가변적이거나, 예측하기 어려운 경우.
