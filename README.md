...
| **큐 용량** | **측정 대상**  | **처리량 (ops/ms)** | **생산 비중** | **소비 비중**  | **메모리 사용량 (MB)** | **GC 시간 (ms)** | **GC 횟수** | **캐시 히트율** | **캐시 미스**     | **IPC**  | **총 대기 시간 (ms)** | **총 대기 수** | **offer 대기 시간 (ms)** | **offer 대기 수** | **poll 대기 시간 (ms)** | **poll 대기 수** | **Condition(notFull) 대기 시간 (ms)** | **Condition(notFull) 대기 수** | **xsnp_hitm** | **xsnp_hit** |
|----------|------------|------------------|-----------|------------|-------------|----------------|-----------|------------|---------------|----------|------------------|------------|----------------------|----------------|---------------------|---------------|-----------------------------------|-----------------------------|---------------|------------|
| **10%**  | **ABQ_1**  | 1,133.75 🟥     | 58.72%    | 41.28% 🟨 | 9.46        | X              | X         | 97.58%     | 18,145.96     | 1.10     | 119.0            | 9.8        | 116.6                | 9.6            | 2.4                 | 0.2           | X                                 | X                           | 0.1702        | 0.012      |
| **10%**  | **LBQ_1**  | 5,623.38 🟥     | 49.99%    | 50.01%     | 74.77       | 1.60           | 0.60      | 95.34%     | 39,414.97     | 0.48     | X                | X          | X                    | X              | X                   | X             | X                                 | X                           | 0.7795        | 0.0368     |
| **10%**  | **ABQ_50** | 20,306.64 🟩    | 50.09%    | 49.91%     | 14.71       | X              | X         | 98.04%     | 17,278.44 🟫 | 1.19 🟦 | 1,491.0          | 71.4       | 774.6                | 36.6           | 716.4               | 34.8          | X                                 | X                           | 0.008         | 0.0005     |
| **10%**  | **LBQ_50** | 7,355.29 🟩     | 50.82%    | 49.18%     | 100.83      | 134.20         | 1.60      | 94.95%     | 22,880.82 🟫 | 0.53 🟦 | 13,884.4         | 146.6      | 6,844.4              | 74.6           | 7,015.8             | 70.6          | 24.2                              | 1.4                         | 0.1791        | 0.0075     |
| **100%** | **ABQ_1**  | 3,161.07 🟥     | 81.58%    | 18.42% 🟨 | 16.02       | X              | X         | 98.83%     | 19,529.81     | 1.37     | 18.2             | 1.8        | 16.2                 | 1.6            | 2.0                 | 0.2           | X                                 | X                           | 0.0869        | 0.0047     |
| **100%** | **LBQ_1**  | 4,449.90 🟥     | 49.98%    | 50.02%     | 68.30       | 1.80           | 0.60      | 96.12%     | 51,394.25     | 0.53     | X                | X          | X                    | X              | X                   | X             | X                                 | X                           | 0.5031        | 0.0315     |
| **100%** | **ABQ_50** | 20,359.63 🟩    | 50.00%    | 50.00%     | 21.89       | 2.00           | 0.20      | 98.00%     | 15,246.14 🟫 | 1.21 🟦 | 2,190.0          | 118.6      | 1,111.0              | 59.8           | 1,079.0             | 58.8          | X                                 | X                           | 0.005         | 0.0003     |
| **100%** | **LBQ_50** | 7,394.79 🟩     | 52.56%    | 47.44%     | 110.06      | 1.00           | 0.20      | 95.19%     | 23,991.66 🟫 | 0.46 🟦 | 1,029.6          | 61.4       | 441.6                | 21.8           | 588.0               | 39.6          | X                                 | X                           | 0.1388        | 0.0079     |

### 스레드 100

| **큐 용량** | **측정 대상**   | **처리량 (ops/ms)** | **생산 비중** | **소비 비중**  | **메모리 사용량 (MB)** | **GC 시간 (ms)** | **GC 횟수** | **캐시 히트율** | **캐시 미스 횟수** | **IPC**  | **총 대기 시간 (ms)** | **총 대기 수** | **offer 대기 시간 (ms)** | **offer 대기 수** | **poll 대기 시간 (ms)** | **poll 대기 수** | **Condition(notFull) 대기 시간 (ms)** | **Condition(notFull) 대기 수** | **xsnp_hitm** | **xsnp_hit** |
|----------|-------------|------------------|-----------|------------|-------------|----------------|-----------|------------|--------------|----------|------------------|------------|----------------------|----------------|---------------------|---------------|-----------------------------------|-----------------------------|---------------|------------|
| **10%**  | **ABQ_1**   | 747.20 🟥       | 63.08%    | 36.92% 🟨 | 15.52       | 4.00           | 0.20      | 97.57%     | 1,378.99     | 0.99     | 2,899.8          | 157.6      | 2,873.4              | 156.2          | 26.4                | 1.4           | X                                 | X                           | 0.0109        | 0.0007     |
| **10%**  | **LBQ_1**   | 4,034.09 🟥     | 49.96%    | 50.04%     | 62.61       | 1.20           | 0.40      | 96.09%     | 5,076.07     | 0.56     | 1,696.6          | 83.8       | 1,696.6              | 83.8           | X                   | X             | X                                 | X                           | 0.112         | 0.0063     |
| **10%**  | **ABQ_100** | 19,456.23 🟩    | 49.97%    | 50.03%     | 22.95       | 2.20           | 0.40      | 99.24%     | 3,203.99 🟫 | 1.33 🟦 | 2,001,197.8      | 112,566.4  | 1,001,309.8          | 56,275.8       | 999,888.0           | 56,290.6      | X                                 | X                           | 0.0008        | 4.9522e-05 |
| **10%**  | **LBQ_100** | 7,214.39 🟩     | 50.34%    | 49.66%     | 105.19      | 26.40          | 0.40      | 97.67%     | 4,626.92 🟫 | 0.75 🟦 | 20,782.0         | 433.2      | 8,642.2              | 212.6          | 11,924.2            | 212.4         | 215.6                             | 8.2                         | 0.0237        | 0.0011     |
| **100%** | **ABQ_1**   | 2,458.97 🟥     | 90.56%    | 9.44% 🟨  | 21.43       | 34.80          | 0.20      | 98.66%     | 1,695.51     | 1.29     | 2,394.0          | 125.6      | 2,377.2              | 124.6          | 16.8                | 1.0           | X                                 | X                           | 0.0093        | 0.0009     |
| **100%** | **LBQ_1**   | 4,230.01 🟥     | 49.95%    | 50.05%     | 71.58       | 1.20           | 0.40      | 96.81%     | 7,644.61     | 0.59     | 1,595.0          | 69.8       | 1,595.0              | 69.8           | X                   | X             | X                                 | X                           | 0.1989        | 0.0129     |
| **100%** | **ABQ_100** | 19,582.77 🟩    | 49.98%    | 50.02%     | 29.91       | 3.80           | 0.40      | 99.35%     | 1,638.78 🟫 | 1.46 🟦 | 1,999,447.8      | 115,567.0  | 999,710.4            | 57,776.2       | 999,737.4           | 57,790.8      | X                                 | X                           | 0.0006        | 3.5718e-05 |
| **100%** | **LBQ_100** | 6,845.90 🟩     | 54.44%    | 45.56%     | 111.36      | 875.60         | 4.40      | 97.53%     | 5,278.40 🟫 | 0.65 🟦 | 191,961.0        | 1,159.2    | 95,576.6             | 553.4          | 96,045.0            | 573.8         | 339.4                             | 32.0                        | 0.024         | 0.0013     |
...
| **큐 용량** | **측정 대상**  | **처리량 (ops/ms)** | **생산 비중** | **소비 비중**  | **메모리 사용량 (MB)** | **GC 시간 (ms)** | **GC 횟수** | **캐시 히트율** | **캐시 미스**     | **IPC**  | **총 대기 시간 (ms)** | **총 대기 수** | **offer 대기 시간 (ms)** | **offer 대기 수** | **poll 대기 시간 (ms)** | **poll 대기 수** | **Condition(notFull) 대기 시간 (ms)** | **Condition(notFull) 대기 수** | **xsnp_hitm** | **xsnp_hit** |
|----------|------------|------------------|-----------|------------|-------------|----------------|-----------|------------|---------------|----------|------------------|------------|----------------------|----------------|---------------------|---------------|-----------------------------------|-----------------------------|---------------|------------|
| **10%**  | **ABQ_1**  | 979.96 🟥       | 60.05%    | 39.95% 🟨 | 9.45        | X              | X         | 97.62%     | 15,461.96     | 1.06     | 136.6            | 11.2       | 131.8                | 10.8           | 4.8                 | 0.4           | X                                 | X                           | 0.1828        | 0.0099     |
| **10%**  | **LBQ_1**  | 4,025.65 🟥     | 49.99%    | 50.01%     | 56.60       | 0.60           | 0.20      | 95.97%     | 51,122.74     | 0.47     | X                | X          | X                    | X              | X                   | X             | X                                 | X                           | 0.4339        | 0.024      |
| **10%**  | **ABQ_50** | 20,519.79 🟩    | 50.01%    | 49.99%     | 15.25       | X              | X         | 98.27%     | 12,682.80 🟫 | 1.31 🟦 | 2,990.0          | 188.4      | 1,557.6              | 95.8           | 1,432.4             | 92.6          | X                                 | X                           | 0.0079        | 0.0004     |
| **10%**  | **LBQ_50** | 7,552.56 🟩     | 50.02%    | 49.98%     | 102.09      | 2.40           | 0.40      | 95.66%     | 16,300.24 🟫 | 0.58 🟦 | 2,287.6          | 167.2      | 797.6                | 65.2           | 1,369.8             | 91.8          | 120.2                             | 10.2                        | 0.2349        | 0.0127     |
| **100%** | **ABQ_1**  | 2,873.46 🟥     | 84.74%    | 15.26% 🟨 | 16.11       | X              | X         | 98.15%     | 19,052.35     | 1.14     | 182.2            | 16.0       | 177.8                | 15.6           | 4.4                 | 0.4           | X                                 | X                           | 0.1293        | 0.0097     |
| **100%** | **LBQ_1**  | 4,692.69 🟥     | 49.99%    | 50.01%     | 70.19       | 1.80           | 0.40      | 94.98%     | 59,013.95     | 0.43     | 214.4            | 19.2       | 214.4                | 19.2           | X                   | X             | X                                 | X                           | 1.0053        | 0.0491     |
| **100%** | **ABQ_50** | 18,825.69 🟩    | 49.98%    | 50.02%     | 21.72       | X              | X         | 98.32%     | 8,246.39 🟫  | 1.30 🟦 | 2,404.8          | 135.8      | 1,434.2              | 72.4           | 970.6               | 63.4          | X                                 | X                           | 0.0053        | 0.0003     |
| **100%** | **LBQ_50** | 8,283.68 🟩     | 50.20%    | 49.80%     | 116.81      | 1.20           | 0.40      | 94.52%     | 30,608.68 🟫 | 0.50 🟦 | 2,599.4          | 96.0       | 428.4                | 30.0           | 862.8               | 64.2          | 44.2                              | 1.8                         | 0.1963        | 0.0121     |

### 스레드 100

| **큐 용량** | **측정 대상**   | **처리량 (ops/ms)** | **생산 비중** | **소비 비중**  | **메모리 사용량 (MB)** | **GC 시간 (ms)** | **GC 횟수** | **캐시 히트율** | **캐시 미스**    | **IPC**  | **총 대기 시간 (ms)** | **총 대기 수** | **offer 대기 시간 (ms)** | **offer 대기 수** | **poll 대기 시간 (ms)** | **poll 대기 수** | **Condition(notFull) 대기 시간 (ms)** | **Condition(notFull) 대기 수** | **xsnp_hitm** | **xsnp_hit** |
|----------|-------------|------------------|-----------|------------|-------------|----------------|-----------|------------|--------------|----------|------------------|------------|----------------------|----------------|---------------------|---------------|-----------------------------------|-----------------------------|---------------|------------|
| **10%**  | **ABQ_1**   | 637.02 🟥       | 65.32%    | 34.68% 🟨 | 14.87       | X              | X         | 98.29%     | 483.22       | 1.16     | 1,890.2          | 85.0       | 1,859.6              | 83.8           | 30.6                | 1.2           | X                                 | X                           | 0.0074        | 0.0005     |
| **10%**  | **LBQ_1**   | 4,247.57 🟥     | 49.96%    | 50.04%     | 64.94       | 0.40           | 0.20      | 97.39%     | 4,630.62     | 0.69     | 1,705.8          | 60.0       | 1,705.8              | 60.0           | X                   | X             | X                                 | X                           | 0.085         | 0.0042     |
| **10%**  | **ABQ_100** | 19,641.51 🟩    | 50.00%    | 50.00%     | 23.06       | X              | X         | 99.31%     | 1,693.86 🟫 | 1.41 🟦 | 2,000,952.6      | 64,481.0   | 999,898.4            | 58,609.4       | 1,001,054.2         | 5,871.6       | X                                 | X                           | 0.0007        | 4.1749e-05 |
| **10%**  | **LBQ_100** | 6,382.36 🟩     | 50.43%    | 49.57%     | 95.68       | 1.00           | 0.20      | 97.95%     | 3,283.32 🟫 | 0.80 🟦 | 15,792.8         | 330.8      | 6,113.0              | 134.2          | 9,204.4             | 178.4         | 475.4                             | 18.2                        | 0.0273        | 0.0013     |
| **100%** | **ABQ_1**   | 2,565.45 🟥     | 88.85%    | 11.15% 🟨 | 22.13       | X              | X         | 98.80%     | 2,225.25     | 1.35     | 2,214.6          | 117.8      | 2,189.4              | 116.6          | 25.2                | 1.2           | X                                 | X                           | 0.0098        | 0.0007     |
| **100%** | **LBQ_1**   | 4,007.78 🟥     | 49.95%    | 50.05%     | 69.06       | 0.40           | 0.20      | 96.63%     | 7,226.02     | 0.61     | 1,958.8          | 76.4       | 1,958.8              | 76.4           | X                   | X             | X                                 | X                           | 0.058         | 0.0031     |
| **100%** | **ABQ_100** | 19,257.95 🟩    | 50.01%    | 49.99%     | 29.22       | X              | X         | 99.39%     | 1,663.71 🟫 | 1.48 🟦 | 2,009,666.8      | 117,847.0  | 1,004,716.2          | 58,917.8       | 1,004,950.6         | 58,929.2      | X                                 | X                           | 0.0006        | 3.4598e-05 |
| **100%** | **LBQ_100** | 7,627.44 🟩     | 51.68%    | 48.32%     | 118.40      | 0.60           | 0.20      | 97.84%     | 4,760.17 🟫 | 0.83 🟦 | 17,654.2         | 508.6      | 8,098.8              | 256.0          | 9,246.8             | 249.2         | 308.6                             | 3.4                         | 0.0212        | 0.0011     |
...
## 5-3. 코어 수 증가가 캐시 일관성 비용에 미치는 영향

2 Core 환경과 4 Core 환경 비교를 통해, 코어 수 증가가 각 자료구조의 캐시 일관성 비용에 미치는 영향을 `xsnp_hitm` 지표로 교차 검증할 수 있었습니다.

`xsnp_hitm`은 한 코어가 캐시라인을 읽으려 할 때 다른 코어가 해당 라인을 이미 수정 상태(Modified)로 보유하고 있어 강제로 넘겨받아야 하는 횟수입니다. 이 지표가 높을수록 코어 간 캐시 일관성 프로토콜이 자주 동작하여 CPU Stall이 발생함을 의미합니다.

### LinkedBlockingQueue: ABQ 대비 20~40배 높은 캐시 일관성 트래픽

MPMC 환경에서 LinkedBlockingQueue는 ArrayBlockingQueue 대비 xsnp_hitm이 전 측정 케이스에서 20~40배 높게 측정되었습니다. LBQ_50과 ABQ_50을 비교하면, 2Core 환경에서 각각 0.1791 대 0.008(cap=10%), 0.1388 대 0.005(cap=100%)로 차이가 극명합니다.

이는 5-2절에서 설명한 LinkedBlockingQueue의 AtomicInteger 기반 `count` 변수가 생산자·소비자 양측 코어에서 지속적으로 수정·읽기 연산이 이루어지는 핫 캐시라인임을 하드웨어 지표로 실증합니다.

코어 수가 증가할수록 LBQ의 캐시 일관성 트래픽도 증가했습니다. LBQ_50 기준 2Core 대비 4Core 환경에서 xsnp_hitm이 cap=10% 조건에서 +31.2%(0.1791 → 0.2349), cap=100% 조건에서 +41.4%(0.1388 → 0.1963) 증가했습니다. `count` 변수를 감시하는 스레드가 더 많은 물리 코어에 분산될수록, 값이 수정될 때마다 더 많은 코어의 캐시라인이 무효화되어 버스 통신 빈도가 증가하기 때문입니다.

### ArrayBlockingQueue: 단일 락으로 인한 낮고 안정적인 캐시 일관성 트래픽

반면, ArrayBlockingQueue의 xsnp_hitm은 코어 수와 무관하게 극히 낮고 안정적인 수준을 유지했습니다. ABQ_50 기준 cap=10%에서 2Core 0.008 → 4Core 0.0079, cap=100%에서 2Core 0.005 → 4Core 0.0053으로 사실상 변화가 없었습니다.

단일 락 구조이기 때문에 배열에 동시에 접근하는 코어가 항상 하나로 제한됩니다. 코어 수가 늘어나도 배열을 수정하는 스레드는 하나뿐이므로 캐시라인 무효화 빈도가 증가하지 않습니다.

### xsnp_hitm과 처리량의 관계

LBQ의 xsnp_hitm이 코어 수 증가와 함께 상승했지만, 처리량에 미치는 영향은 스레드 수에 따라 달랐습니다.

LBQ_50의 경우, 4Core 환경의 추가적인 물리 병렬성이 증가한 캐시 일관성 비용을 상쇄하여 처리량이 오히려 증가했습니다(cap=10%: 7,355 → 7,552 ops/ms, +2.7%; cap=100%: 7,394 → 8,283 ops/ms, +12.0%).

그러나 스레드 수가 많은 LBQ_100에서는 캐시 일관성 비용의 영향이 더 두드러졌습니다. cap=10% 조건에서 4Core 전환 시 LBQ_100의 처리량이 7,214 → 6,382 ops/ms(-11.5%) 감소한 반면, ABQ_100은 동일 조건에서 19,456 → 19,641 ops/ms(+0.96%)로 안정적이었습니다.

### 정리

xsnp_hitm 지표는 LinkedBlockingQueue의 AtomicInteger 기반 캐시 일관성 병목이 이론적 추론에 그치지 않고 실제 하드웨어에서 발생하고 있음을 수치로 보여줍니다. LBQ는 ABQ 대비 20~40배 높은 캐시 일관성 트래픽을 발생시키며, 스레드 수가 많을수록 코어 증가가 처리량 저하로 이어질 수 있는 구조적 취약성이 있습니다. ArrayBlockingQueue는 단일 락 기반의 접근 직렬화를 통해 캐시 일관성 트래픽을 최소화하고 코어 수와 무관하게 일관된 성능을 유지합니다.
...
1. 가벼운 내부 연산 및 낮은 캐시 일관성 비용
   ...
   - 배열을 수정하는 스레드가 항상 하나로 직렬화되므로, 코어 간 캐시라인 경합을 나타내는 xsnp_hitm이 LBQ 대비 20~40배 낮게 유지됩니다. (5-3절 참고)
2. 객체 생성 없는 참조 매핑
...
3. 연속 연산 시 캐시 미스
   ...
   - MPMC 환경에서 xsnp_hitm이 ABQ 대비 20~40배 높게 측정되었으며, 코어 수가 증가할수록 이 값이 더 커지는 경향을 보였습니다. (5-3절 참고)
